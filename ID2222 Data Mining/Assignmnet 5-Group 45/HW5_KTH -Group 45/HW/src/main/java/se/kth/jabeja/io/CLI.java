...
public class CLI {
  ...
  @Option(name = "-optionAnnealing", usage = "Annealing option, linear or exp")
  private String optionAnnealing = "linear";

  @Option(name = "-optionAccepyanceProb", usage = "Annealing option, linearAccepatnce or expAccepatnce")
  private String optionAccepyanceProb = "linearAccepatnce";

  @Option(name="-roundtoRestart", usage = "choose to set T to intaial value after n rounds")
  private int roundtoRestart = -1;
  ...
  public Config parseArgs(String[] args) throws FileNotFoundException {
    ...
    return new Config().setRandNeighborsSampleSize(randNeighborsSampleSize)
            ...
            .setAlpha(ALPHA)
            .setAnnealingOption(optionAnnealing)
            .setOptionAccepyanceProb(optionAccepyanceProb)
            .setRoundstoRestart(roundtoRestart);
  }
}