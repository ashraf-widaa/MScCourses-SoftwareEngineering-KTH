...
public class Config {
    ...
    private Float alpha;
    private String optionAnnealing;
    private Integer roundtoRestart;

    private String optionAccepyanceProb;
    ...
    public Config setRestartOption(boolean restartOption) {
        // If needed, you can add logic here to handle restartOption
        return this;
    }
    ...
    public Config setRoundstoRestart(Integer roundtoRestart) {
        this.roundtoRestart = roundtoRestart;
        return this;
    }
    ...
    public Config setAnnealingOption() {
        // If needed, you can add logic here to handle linearAnnealing
        return this;
    }

    public String getAnnealingOption() {
        if (optionAnnealing == null) {
            throw new NullPointerException("Annealing option is not set");
        }
        return optionAnnealing;
    }

    public Config setAnnealingOption(String optionAnnealing) {
        this.optionAnnealing = optionAnnealing;
        return this;
    }

    public Integer getRoundstoRestart() {
        if (roundtoRestart == null) {
            throw new NullPointerException("Error Select Rounds NO");
        }
        return roundtoRestart;
    }

    public Config setOptionAccepyanceProb(String optionAccepyanceProb) {
        this.optionAccepyanceProb = optionAccepyanceProb;
        return this;
    }

    public String getOptionAccepyanceProb() {
        if (optionAccepyanceProb == null) {
            throw new NullPointerException("Option acceptance probability is not set");
        }
        return optionAccepyanceProb;
    }
}
